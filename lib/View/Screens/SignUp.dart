            ...
            child: Column(
              children: [
                ...
                Form(child: Padding(
                  ...
                  child: Column(
                    children: [
                      CustomTextFormFiled(hint: 'Enter Your Name',
                        secure:false,eyeView: false,name: 'Full Name',icon: FontAwesomeIcons.user,),
                      CustomTextFormFiled(hint: 'Enter Your Email',
                        secure:false,eyeView: false,name: 'Email',icon: Icons.email,),
                      CustomTextFormFiled(hint: 'Enter Your Pass',
                        secure:false,eyeView: false,name: 'Password',icon: Icons.lock,),
                      CustomTextFormFiled(hint: 'Confirm Your Pass',
                        secure:false,eyeView: false,name: 'Confirm Password',icon: Icons.lock,),
                    ],
                  ),
                ),),
